// ÚLTIMO BASTIÃO 3D — áudio
const AudioSys = (() => {
  const sfxFiles = {
    shot: 'shot.ogg', tower: 'tower.ogg', zdie1: 'zdie1.ogg', zdie2: 'zdie2.ogg',
    coin: 'coin.ogg', hurt: 'hurt.ogg', bite: 'bite.ogg', boom: 'boom.ogg',
    upgrade: 'upgrade.ogg', click: 'click.ogg', confirm: 'confirm.ogg',
  };
  ...
  function load() {
    ...
    for (const [n, f] of Object.entries(musicFiles)) {
      ...
      a.preload = 'auto'; a.loop = true; a.volume = 0.42;
      music[n] = a;
    }
  }
