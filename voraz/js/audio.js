...
const AudioSys = (() => {
  const sfxFiles = {
    eat1: 'eat1.ogg', eat2: 'eat2.ogg', eat3: 'eat3.ogg',
    crunch1: 'crunch1.ogg', crunch2: 'crunch2.ogg', crunch3: 'crunch3.ogg',
    crash1: 'crash1.ogg', crash2: 'crash2.ogg', bigcrash: 'bigcrash.ogg',
    rumble: 'rumble.ogg', warn: 'warn.ogg', up: 'up.ogg',
    combo1: 'combo1.ogg', combo2: 'combo2.ogg', combo3: 'combo3.ogg',
    combo4: 'combo4.ogg', combo5: 'combo5.ogg',
    levelup: 'levelup.ogg', devour: 'devour.ogg', rival: 'rival.ogg',
  };
  ...
  function load() {
    ...
    for (const [n, f] of Object.entries(musicFiles)) {
      ...
      a.preload = 'auto'; a.loop = true; a.volume = 0.34;
      music[n] = a;
    }
  }
