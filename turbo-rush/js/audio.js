// TURBO RUSH — áudio (SFX + música)
const AudioSys = (() => {
  const sfxFiles = {
    crash: 'crash.ogg', explosion: 'explosion.ogg', turbo: 'turbo.ogg',
    click: 'click.ogg', confirm: 'confirm.ogg', swerve: 'swerve.ogg',
  };
  const musicFiles = { drive: 'drive.ogg', gameover: 'gameover.ogg' };
