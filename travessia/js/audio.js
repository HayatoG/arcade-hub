// TRAVESSIA — áudio (padrão AudioSys do hub)
const AudioSys = (() => {
  const sfxFiles = {
    jump: 'jump.ogg', coin: 'coin.ogg', hit: 'hit.ogg', splash: 'splash.ogg',
    bell: 'bell.ogg', train: 'train.ogg', eagle: 'eagle.ogg', woosh: 'woosh.ogg',
    click: 'click.ogg', confirm: 'confirm.ogg', unlock: 'unlock.ogg',
    dup: 'dup.ogg', record: 'record.ogg', lose: 'lose.ogg', tick: 'tick.ogg',
  };
